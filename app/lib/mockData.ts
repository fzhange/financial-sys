...
// 应付账款-发票关联关系
export const mockPayableInvoiceRelations: PayableInvoiceRelation[] = [
  {
    id: 'pir-1',
    payableId: 'ap-1',
    payableNo: 'AP202412001',
...
// 模拟请款单数据
// 业务流程：请款单只关联应付账款，发票信息通过应付账款间接获取
